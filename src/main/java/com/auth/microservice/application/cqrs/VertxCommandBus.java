...
import com.auth.microservice.application.cqrs.exceptions.CommandNotFoundException;
import com.auth.microservice.application.cqrs.exceptions.HandlerRegistrationException;
...
public class VertxCommandBus implements CommandBus {
    ...
    public <T> Future<T> execute(Command command) {
        logger.debug("Executing command: {}", command);
        
        CommandHandler<Command, T> handler = (CommandHandler<Command, T>) handlers.get(command.getClass());
